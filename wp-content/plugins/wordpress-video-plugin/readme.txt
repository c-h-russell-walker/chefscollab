...
The Wordpress Video Plugin adds a filter for WordPress that allows easy video embedding of 65 supported video sites. 
...
Then activate it. Afterwards, you can include a video on your posts or pages. Every occurence of the expression [site id] (case unsensitive) 
will start as an embedded flash player. Replace 'site' with the name of the videosite and 'id' with the video id.
...
http://www.aniboom.com/animation-video/479823/Yaku-Shortfilm/, the id part is 479823
