...
class hl_twitter_widget extends WP_Widget {
	...
	public function form($instance) {
		...
		$users = $wpdb->get_results('
			SELECT twitter_user_id, screen_name
		...
		<p>
			...
			<input type="text" id="<?php echo $this->get_field_id('widget_title'); ?>" name="<?php echo $this->get_field_name('widget_title'); ?>" value="<?php echo esc_attr($widget_title); ?>" />
		</p>
		...
		<p>
			...
			<select id="<?php echo $this->get_field_id('user_id'); ?>" name="<?php echo $this->get_field_name('user_id'); ?>">
				...
				<?php foreach($users as $user): ?>
					<option value="<?php echo esc_attr($user->twitter_user_id); ?>"<?php if($user->twitter_user_id==$user_id) echo ' selected="selected"'; ?>><?php echo hl_e($user->screen_name); ?></option>
				<?php endforeach; ?>
			</select>
		</p>
		...
		<p>
			...
			<select id="<?php echo $this->get_field_id('num_tweets'); ?>" name="<?php echo $this->get_field_name('num_tweets'); ?>">
				<?php foreach($poss_num_tweets as $num): ?>
					<option value="<?php echo esc_attr($num); ?>"<?php if($num_tweets==$num) echo ' selected="selected"'; ?>><?php echo $num; ?></option>
				<?php endforeach; ?>
			</select>
		</p>
